...
;;
;;  (setq load-path (cons (expand-file-name "/dir/with/cmake-mode")
;; load-path))
;;  (require 'cmake-mode)
...
optional argument topic will be appended to the argument list."
  ...
  (let* ((bufname (concat "*CMake" type (if topic "-") topic "*"))
    ...
    (if buffer
      ...
      ;; We don't want the contents of the shell-command running to
      ;; the
      ...
      ;; Save the original window, so that we can come back to it
      ;; later.
